...
/**
Leslie Ducray - 2014
AccountBean class for storing the service user's account details
maps to 'cm_accounts' and is associated to 'cm_transactions' database entity (TransactionBean)
 */
